...
class Spoofing_valtest_UUID(Dataset):

    def __init__(self, info_list, root_dir, UUID=-1,transform=None):
    ...
    def __getitem__(self, idx):
        ...
        sample = {'image_x': image_x, 'image_x_depth': image_x_depth, 'image_x_ir': image_x_ir, 'spoofing_label': spoofing_label, 'map_x1': map_x1,'UUID':UUID}
